...
void LmicedTrader::StartAutoOrder() {
    printf("StartAutoOrder\n");
}

void LmicedTrader::OnFrontConnected()
{
    CZeusingFtdcReqUserLoginField reqUserLogin;
    memset(&reqUserLogin,0,sizeof(CZeusingFtdcReqUserLoginField));
...
void LmicedTrader::OnRspUserLogin(CZeusingFtdcRspUserLoginField *pRspUserLogin, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void LmicedTrader::OnRspOrderInsert(CZeusingFtdcInputOrderField *pInputOrder, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
        printf("-----------------------------\n");
...
void LmicedTrader::OnRtnTrade(CZeusingFtdcTradeField *pTrade)
{
    printf("-----------------------------\n");
    printf("收到成交回报\n");
    //Show(pTrade);
...
void LmicedTrader::Show(CZeusingFtdcTradeField *pTrade)
{
    printf("-----------------------------\n");
//    printf("交易所代码=[%s]\n",pTrade->ExchangeID);
//    printf("交易日=[%s]\n",pTrade->TradingDay);
...
void LmicedTrader::Show(CZeusingFtdcOrderField *pOrder)
{
    printf("-----------------------------\n");
//    printf("交易所代码=[%s]\n",pOrder->ExchangeID);
//    printf("交易日=[%s]\n",pOrder->TradingDay);
...
void LmicedTrader::OnRtnOrder(CZeusingFtdcOrderField *pOrder)
{
    printf("-----------------------------\n");
    printf("收到报单回报\n");
    Show(pOrder);
...
void LmicedTrader::OnRspOrderAction(CZeusingFtdcInputOrderActionField *pOrderAction, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
        printf("-----------------------------\n");
...
void LmicedTrader::OnRspUserPasswordUpdate(CZeusingFtdcUserPasswordUpdateField *pUserPasswordUpdate, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
        printf("-----------------------------\n");
...
void LmicedTrader::OnErrRtnOrderInsert(CZeusingFtdcInputOrderField *pInputOrder, CZeusingFtdcRspInfoField *pRspInfo)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
        printf("-----------------------------\n");
...
void LmicedTrader::OnErrRtnOrderAction(CZeusingFtdcOrderActionField *pOrderAction, CZeusingFtdcRspInfoField *pRspInfo)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
        printf("-----------------------------\n");
...
void LmicedTrader::OnRspQryOrder(CZeusingFtdcOrderField *pOrder, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
        printf("-----------------------------\n");
...
void LmicedTrader::OnRspQryTrade(CZeusingFtdcTradeField *pTrade, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
        printf("-----------------------------\n");
...
void LmicedTrader::OnRspQryExchange(CZeusingFtdcExchangeField *pRspExchange, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
        printf("-----------------------------\n");
...
//void LmicedTrader::OnRspQryInvestorAccount(CZeusingFtdcRspInvestorAccountField *pRspInvestorAccount, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
//{
//    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
//    {
//        printf("-----------------------------\n");
...
//void LmicedTrader::OnRspQryUserInvestor(CZeusingFtdcRspUserInvestorField *pUserInvestor, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
//{
//    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
//    {
//        printf("-----------------------------\n");
...
void LmicedTrader::Show(CZeusingFtdcInstrumentField *pRspInstrument)
{
    printf("-----------------------------\n");
...
void LmicedTrader::OnRspQryInstrument(CZeusingFtdcInstrumentField *pRspInstrument, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
...
void LmicedTrader::OnRspQryTradingCode(CZeusingFtdcTradingCodeField *pTradingCode, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
        printf("查询交易编码失败 错误原因：%s\n",pRspInfo->ErrorMsg);
...
void LmicedTrader::OnRspQryInvestorPosition(CZeusingFtdcInvestorPositionField *pRspInvestorPosition, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
    {
...
//    ///投资者手续费率查询应答
//void LmicedTrader::OnRspQryInvestorFee(CZeusingFtdcInvestorFeeField *pInvestorFee, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
//{
//    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
//    {
...
//    ///投资者保证金率查询应答
//void LmicedTrader::OnRspQryInvestorMargin(CZeusingFtdcInvestorMarginField *pInvestorMargin, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
//{
//    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
//    {
...
//void LmicedTrader::OnRspQryComplianceParam(CZeusingFtdcRspComplianceParamField *pRspComplianceParam, CZeusingFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
//{
//    if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
//    {
...
int icount=0;
void LmicedTrader::OnRtnInstrumentStatus(CZeusingFtdcInstrumentStatusField *pInstrumentStatus)
{
...
//void LmicedTrader::OnRtnInvestorAccountDeposit(CZeusingFtdcInvestorAccountDepositResField *pInvestorAccountDepositRes)
//{
